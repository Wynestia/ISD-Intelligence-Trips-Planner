  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh - 64px)', overflow: 'hidden', fontFamily: "'Segoe UI', sans-serif" }}>
          ...
          {sessions.map(s => {
            ...
            return (
              <button
                ...
                style={{ width: '100%', textAlign: 'left', padding: '10px 12px', borderRadius: '8px', border: 'none', background: isActive ? 'rgba(141,149,126,0.2)' : 'transparent', color: isActive ? '#8D957E' : '#5a6350', cursor: 'pointer', marginBottom: '2px' }}
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#f0f2ee', overflow: 'hidden' }}>
        {/* Header */}
        <div style={{ padding: '16px 24px', borderBottom: '1px solid #c4cbb9', background: '#fff', display: 'flex', alignItems: 'center', gap: '10px', minHeight: '64px' }}>
          {activeSessionData
            ? <>
